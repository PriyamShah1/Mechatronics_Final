...
override PKGDIR = xconfig_lab2_lance
...
package/%.xdc.inc package/%_xconfig_lab2_lance.c package/%.defs.h: %.xdc $(PKGCFGS)
	@$(MSG) generating interfaces for package xconfig_lab2_lance" (because $@ is older than $(firstword $?))" ...
	$(XSRUN) -f xdc/services/intern/cmd/build.xs $(MK_IDLOPTS) -m package/package.xdc.dep -i package/package.xdc.inc package.xdc

.dlls,e674 .dlls: lab2_lance.pe674

-include package/cfg/lab2_lance_pe674.mak
-include package/cfg/lab2_lance_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/lab2_lance_pe674.dep
endif
lab2_lance.pe674: package/cfg/lab2_lance_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
lab2_lance.pe674 package/cfg/lab2_lance_pe674.c: .libraries,e674
endif

package/cfg/lab2_lance_pe674.c package/cfg/lab2_lance_pe674.h package/cfg/lab2_lance_pe674.xdl: override _PROG_NAME := lab2_lance.xe674
package/cfg/lab2_lance_pe674.c: package/cfg/lab2_lance_pe674.cfg
package/cfg/lab2_lance_pe674.xdc.inc: package/cfg/lab2_lance_pe674.xdl
package/cfg/lab2_lance_pe674.xdl package/cfg/lab2_lance_pe674.c: .interfaces

clean:: clean,e674
	-$(RM) package/cfg/lab2_lance_pe674.cfg
	-$(RM) package/cfg/lab2_lance_pe674.dep
	-$(RM) package/cfg/lab2_lance_pe674.c
	-$(RM) package/cfg/lab2_lance_pe674.xdc.inc

clean,e674::
	-$(RM) lab2_lance.pe674
.executables,e674 .executables: lab2_lance.xe674

lab2_lance.xe674: |lab2_lance.pe674

-include package/cfg/lab2_lance.xe674.mak
lab2_lance.xe674: package/cfg/lab2_lance_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/cl6x -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --abi=eabi -z  -o $@ package/cfg/lab2_lance_pe674.oe674   package/cfg/lab2_lance_pe674.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/libc.a
	
lab2_lance.xe674: export C_DIR=
lab2_lance.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
lab2_lance.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

lab2_lance.test test,e674 test: lab2_lance.xe674.test

lab2_lance.xe674.test:: lab2_lance.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 lab2_lance.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.lab2_lance.xe674, ) 
endif

clean,e674::
	-$(RM) $(wildcard .tmp,lab2_lance.xe674,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
lab2_lance_pe674.oe674,copy : package/cfg/lab2_lance_pe674.oe674
lab2_lance_pe674.se674,copy : package/cfg/lab2_lance_pe674.se674

$(XDCCFGDIR)%.c $(XDCCFGDIR)%.h $(XDCCFGDIR)%.xdl: $(XDCCFGDIR)%.cfg $(XDCROOT)/packages/xdc/cfg/Main.xs | .interfaces
	@$(MSG) "configuring $(_PROG_NAME) from $< ..."
	$(CONFIG) $(_PROG_XSOPTS) xdc.cfg $(_PROG_NAME) $(XDCCFGDIR)$*.cfg $(XDCCFGDIR)$*

.PHONY: release,xconfig_lab2_lance
ifeq (,$(MK_NOGENDEPS))
-include package/rel/xconfig_lab2_lance.tar.dep
endif
package/rel/xconfig_lab2_lance/xconfig_lab2_lance/package/package.rel.xml: package/package.bld.xml
package/rel/xconfig_lab2_lance/xconfig_lab2_lance/package/package.rel.xml: package/build.cfg
package/rel/xconfig_lab2_lance/xconfig_lab2_lance/package/package.rel.xml: package/package.xdc.inc
package/rel/xconfig_lab2_lance/xconfig_lab2_lance/package/package.rel.xml: .force
	@$(MSG) generating external release references $@ ...
	$(XS) $(JSENV) -f $(XDCROOT)/packages/xdc/bld/rel.js $(MK_RELOPTS) . $@

xconfig_lab2_lance.tar: package/rel/xconfig_lab2_lance.xdc.inc package/rel/xconfig_lab2_lance/xconfig_lab2_lance/package/package.rel.xml
	@$(MSG) making release file $@ "(because of $(firstword $?))" ...
	-$(RM) $@
	$(call MKRELTAR,package/rel/xconfig_lab2_lance.xdc.inc,package/rel/xconfig_lab2_lance.tar.dep)


release release,xconfig_lab2_lance: all xconfig_lab2_lance.tar
clean:: .clean
	-$(RM) xconfig_lab2_lance.tar
	-$(RM) package/rel/xconfig_lab2_lance.xdc.inc
	-$(RM) package/rel/xconfig_lab2_lance.tar.dep
