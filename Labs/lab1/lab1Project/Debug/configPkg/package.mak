...
.dlls,e674 .dlls: lab1.pe674

-include package/cfg/lab1_pe674.mak
-include package/cfg/lab1_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/lab1_pe674.dep
endif
lab1.pe674: package/cfg/lab1_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
lab1.pe674 package/cfg/lab1_pe674.c: .libraries,e674
endif

package/cfg/lab1_pe674.c package/cfg/lab1_pe674.h package/cfg/lab1_pe674.xdl: override _PROG_NAME := lab1.xe674
package/cfg/lab1_pe674.c: package/cfg/lab1_pe674.cfg
package/cfg/lab1_pe674.xdc.inc: package/cfg/lab1_pe674.xdl
package/cfg/lab1_pe674.xdl package/cfg/lab1_pe674.c: .interfaces

clean:: clean,e674
	-$(RM) package/cfg/lab1_pe674.cfg
	-$(RM) package/cfg/lab1_pe674.dep
	-$(RM) package/cfg/lab1_pe674.c
	-$(RM) package/cfg/lab1_pe674.xdc.inc

clean,e674::
	-$(RM) lab1.pe674
.executables,e674 .executables: lab1.xe674

lab1.xe674: |lab1.pe674

-include package/cfg/lab1.xe674.mak
lab1.xe674: package/cfg/lab1_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/cl6x -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --abi=eabi -z  -o $@ package/cfg/lab1_pe674.oe674   package/cfg/lab1_pe674.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/libc.a
	
lab1.xe674: export C_DIR=
lab1.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
lab1.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

lab1.test test,e674 test: lab1.xe674.test

lab1.xe674.test:: lab1.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 lab1.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.lab1.xe674, ) 
endif

clean,e674::
	-$(RM) $(wildcard .tmp,lab1.xe674,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
lab1_pe674.oe674,copy : package/cfg/lab1_pe674.oe674
lab1_pe674.se674,copy : package/cfg/lab1_pe674.se674
