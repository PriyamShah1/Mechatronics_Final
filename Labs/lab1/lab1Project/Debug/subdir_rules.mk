...
ColorLCD.obj: C:/hzhou39_decamar2_ashwina2/SE423Repo/Labs/lab1/source/ColorLCD.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C6000 Compiler'
...
ColorVision.obj: C:/hzhou39_decamar2_ashwina2/SE423Repo/Labs/lab1/source/ColorVision.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C6000 Compiler'
...
LCDprintf.obj: C:/hzhou39_decamar2_ashwina2/SE423Repo/Labs/lab1/source/LCDprintf.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C6000 Compiler'
...
Ladar.obj: C:/hzhou39_decamar2_ashwina2/SE423Repo/Labs/lab1/source/Ladar.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C6000 Compiler'
...
MatrixMath.obj: C:/hzhou39_decamar2_ashwina2/SE423Repo/Labs/lab1/source/MatrixMath.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C6000 Compiler'
...
build-119093391:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-119093391-inproc

build-119093391-inproc: C:/hzhou39_decamar2_ashwina2/SE423Repo/Labs/lab1/SYSBIOS/lab1.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-119093391 C:/hzhou39_decamar2_ashwina2/SE423Repo/Labs/lab1/SYSBIOS/lab1.cfg
configPkg/compiler.opt: build-119093391
configPkg/: build-119093391

pru.obj: C:/hzhou39_decamar2_ashwina2/SE423Repo/Labs/lab1/source/pru.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C6000 Compiler'
...
user_lab1.obj: C:/hzhou39_decamar2_ashwina2/SE423Repo/Labs/lab1/source/user_lab1.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C6000 Compiler'
	"C:/CCStudio_v8/ccsv8/tools/compiler/ti-cgt-c6000_8.2.2/bin/cl6x" -mv6740 -O3 --opt_for_speed=5 --include_path="../../" --include_path="configPkg/package/cfg/" --include_path="../../../../LabFiles/sharedmem_com" --include_path="../../../../LabFiles/mcbsp_com" --include_path="../../include" --include_path="../../../../LabFiles/bsl_forSYSBIOS/inc" --include_path="C:/hzhou39_decamar2_ashwina2/SE423Repo/Labs/lab1/lab1Project" --include_path="C:/CCStudio_v8/ccsv8/tools/compiler/ti-cgt-c6000_8.2.2/include" --define=RUNNING_ON_OMAPL138 --define=PHILIPSCOLORLCD --define=omapl138 -g --diag_warning=225 --diag_wrap=off --display_error_number --auto_inline=0 --preproc_with_compile --preproc_dependency="user_lab1.d_raw" $(GEN_OPTS__FLAG) "$<"
	@echo 'Finished building: "$<"'
	@echo ' '

user_xy.obj: C:/hzhou39_decamar2_ashwina2/SE423Repo/Labs/lab1/source/user_xy.c $(GEN_OPTS) | $(GEN_HDRS)
	@echo 'Building file: "$<"'
	@echo 'Invoking: C6000 Compiler'
