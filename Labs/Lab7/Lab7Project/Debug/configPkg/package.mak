...
.dlls,e674 .dlls: Lab7.pe674

-include package/cfg/Lab7_pe674.mak
-include package/cfg/Lab7_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Lab7_pe674.dep
endif
Lab7.pe674: package/cfg/Lab7_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
Lab7.pe674 package/cfg/Lab7_pe674.c: .libraries,e674
endif

package/cfg/Lab7_pe674.c package/cfg/Lab7_pe674.h package/cfg/Lab7_pe674.xdl: override _PROG_NAME := Lab7.xe674
package/cfg/Lab7_pe674.c: package/cfg/Lab7_pe674.cfg
package/cfg/Lab7_pe674.xdc.inc: package/cfg/Lab7_pe674.xdl
package/cfg/Lab7_pe674.xdl package/cfg/Lab7_pe674.c: .interfaces

clean:: clean,e674
	-$(RM) package/cfg/Lab7_pe674.cfg
	-$(RM) package/cfg/Lab7_pe674.dep
	-$(RM) package/cfg/Lab7_pe674.c
	-$(RM) package/cfg/Lab7_pe674.xdc.inc

clean,e674::
	-$(RM) Lab7.pe674
.executables,e674 .executables: Lab7.xe674

Lab7.xe674: |Lab7.pe674

-include package/cfg/Lab7.xe674.mak
Lab7.xe674: package/cfg/Lab7_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/cl6x -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --abi=eabi -z  -o $@ package/cfg/Lab7_pe674.oe674   package/cfg/Lab7_pe674.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/libc.a
	
Lab7.xe674: export C_DIR=
Lab7.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
Lab7.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

Lab7.test test,e674 test: Lab7.xe674.test

Lab7.xe674.test:: Lab7.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Lab7.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Lab7.xe674, ) 
endif

clean,e674::
	-$(RM) $(wildcard .tmp,Lab7.xe674,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Lab7_pe674.oe674,copy : package/cfg/Lab7_pe674.oe674
Lab7_pe674.se674,copy : package/cfg/Lab7_pe674.se674
