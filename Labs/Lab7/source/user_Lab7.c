...
void RobotControl(void) {
	...
	DutyCycle = enc3/10;
    if ((count%250)==0){
        LCDPrintfLine(1,"Enc3: %.1f",enc3);
        LCDPrintfLine(2,"Angle: ");
        count = 0;
    }
    count++;

	SetRobotOutputs(vref,turn,DutyCycle,DutyCycle,DutyCycle,DutyCycle,DutyCycle,0,0,0);
