...
.dlls,e674 .dlls: Lab8.pe674

-include package/cfg/Lab8_pe674.mak
-include package/cfg/Lab8_pe674.cfg.mak
ifeq (,$(MK_NOGENDEPS))
-include package/cfg/Lab8_pe674.dep
endif
Lab8.pe674: package/cfg/Lab8_pe674.xdl
	@


ifeq (,$(wildcard .libraries,e674))
Lab8.pe674 package/cfg/Lab8_pe674.c: .libraries,e674
endif

package/cfg/Lab8_pe674.c package/cfg/Lab8_pe674.h package/cfg/Lab8_pe674.xdl: override _PROG_NAME := Lab8.xe674
package/cfg/Lab8_pe674.c: package/cfg/Lab8_pe674.cfg
package/cfg/Lab8_pe674.xdc.inc: package/cfg/Lab8_pe674.xdl
package/cfg/Lab8_pe674.xdl package/cfg/Lab8_pe674.c: .interfaces

clean:: clean,e674
	-$(RM) package/cfg/Lab8_pe674.cfg
	-$(RM) package/cfg/Lab8_pe674.dep
	-$(RM) package/cfg/Lab8_pe674.c
	-$(RM) package/cfg/Lab8_pe674.xdc.inc

clean,e674::
	-$(RM) Lab8.pe674
.executables,e674 .executables: Lab8.xe674

Lab8.xe674: |Lab8.pe674

-include package/cfg/Lab8.xe674.mak
Lab8.xe674: package/cfg/Lab8_pe674.oe674 
	$(RM) $@
	@$(MSG) lnke674 $@ ...
	$(RM) $(XDCCFGDIR)/$@.map
	$(ti.targets.elf.C674.rootDir)/bin/cl6x -fs $(XDCCFGDIR)$(dir $@). -q -u _c_int00 --abi=eabi -z  -o $@ package/cfg/Lab8_pe674.oe674   package/cfg/Lab8_pe674.xdl  -w -c -m $(XDCCFGDIR)/$@.map -l $(ti.targets.elf.C674.rootDir)/lib/libc.a
	
Lab8.xe674: export C_DIR=
Lab8.xe674: PATH:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)
Lab8.xe674: Path:=$(ti.targets.elf.C674.rootDir)/bin/;$(PATH)

Lab8.test test,e674 test: Lab8.xe674.test

Lab8.xe674.test:: Lab8.xe674
ifeq (,$(_TESTLEVEL))
	@$(MAKE) -R -r --no-print-directory -f $(XDCROOT)/packages/xdc/bld/xdc.mak _TESTLEVEL=1 Lab8.xe674.test
else
	@$(MSG) running $<  ...
	$(call EXEC.Lab8.xe674, ) 
endif

clean,e674::
	-$(RM) $(wildcard .tmp,Lab8.xe674,*)
...
%,copy:
	...
	$(RM) $@
	$(CP) $< $@
Lab8_pe674.oe674,copy : package/cfg/Lab8_pe674.oe674
Lab8_pe674.se674,copy : package/cfg/Lab8_pe674.se674
